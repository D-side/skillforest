...
Лес навыков это инструмент для отслеживания навыков и способов их развивать. "Дерево навыков", хорошо известное понятие в ролевых играх (RPG), это набор навыков, в котором некоторые навыки зависят от некоторых других. Лес навыков это среда, где **отдельные деревья** навыков могут расти и взаимодействовать между собой. Отсюда и название **"лес навыков"**.
...
Известно множество попыток "игрофицировать" процесс получения технических навыков. Большая их часть это более-менее прямые применения игровых концепций к реальным навыкам: достижений, уровней, и т. п. Но применение тех же концепций к реальным навыкам требует **серьёзных упрощений**. Настолько серьёзных, что в результате получается масса слабых мест.

Разработка этой концепции началась в ответ на предложение на [meta.ru.StackOverflow][3] собирать "СПИски Навыков И Знаний" ("спинизы"), грубо разбитые на уровни "начальный", "средний" и "продвинутый", где к каждому пункту приложены материалы для изучения.
...
* **Не перегружать. Мотивировать учиться**, показывая, что "это не **настолько** сложно".
...
* Виден -- навык, все требования для которого освоены, его можно осваивать сейчас
  - **Не имеет отметки**
  - Все навыки, требуемые для него (если их нет, тогда [согласно vacuous truth][2] условие выполнено) **отмечены**
